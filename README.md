...
# Summary
The Spydar program measures dns records in dns caches by setting the RD bit to zero. This can be used to find malware command and control domains that 
are found by periodically measuring a cache.  It has a web interface for viewing the results.
