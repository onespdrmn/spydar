...
I recommend you start it in the foreground initially so you can see when it finds measurements.  

It can also update itself to add new features.  This feature is not currently enabled as I am working out infrastructure.
